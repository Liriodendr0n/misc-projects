function [A, a1, a2, a3] = vorlatA(xyzC, xyzVL, xyzVR, n)
...
a1 = BiotSavart(xyzC(:,I), xyzVL(:,J)+dTV, xyzVL(:,J), 1, 0);
a2 = BiotSavart(xyzC(:,I), xyzVL(:,J), xyzVR(:,J), 1, 0);
a3 = BiotSavart(xyzC(:,I), xyzVR(:,J), xyzVR(:,J)+dTV, 1, 0);
